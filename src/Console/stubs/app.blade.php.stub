...
<body class="w-full flex flex-no-wrap bg-gray-700">

    <header class="fixed w-full bg-violet-500 text-white px-3 flex items-center shadow-lg gap-3 h-14 z-50">
        <span>
        ...
        <div class="w-full flex justify-between items-center">
            ...
            <div class="flex items-center gap-2">
                <span class="font-medium">{{ auth()->user()->fname }}</span>
